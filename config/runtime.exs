...
config :malan,
       ...
       build_int_overrides.([
         ...
         {:login_ip_upper_limit_count, "LOGIN_IP_UPPER_LIMIT_COUNT"},
         {:registration_ip_lower_limit_msecs, "REGISTRATION_IP_LOWER_LIMIT_MSECS"},
         {:registration_ip_lower_limit_count, "REGISTRATION_IP_LOWER_LIMIT_COUNT"},
         {:registration_ip_upper_limit_msecs, "REGISTRATION_IP_UPPER_LIMIT_MSECS"},
         {:registration_ip_upper_limit_count, "REGISTRATION_IP_UPPER_LIMIT_COUNT"},
